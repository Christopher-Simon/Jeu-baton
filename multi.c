...
int playMultiValue(int batonsRetire,int nombreDeBatons,int* currentPlayer,int player1,int player2) /* Identifie la valeur entrée dans game, si elle est supérieur ou inférieur à 3, n'effectue aucune action */
{
