...
int main()
{
    ...
    printf("Du style plutot impatient et un peu audacieux/impetueux(a trouver).\n");
    printf("J'ai ouvert OpenClassroom, récupere un vieux jeu que mon pere me faisait petit, \n");
